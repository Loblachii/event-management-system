...
Partial Class Dashboard
    ...
    Private Sub InitializeComponent()
        ...
        Button6.Location = New Point(361, 200)
        Button6.Margin = New Padding(3, 2, 3, 2)
        Button6.Name = "Button6"
        Button6.Size = New Size(350, 158)
        Button6.TabIndex = 1
        ...
        Button8.Location = New Point(1128, 200)
        Button8.Margin = New Padding(3, 2, 3, 2)
        Button8.Name = "Button8"
        Button8.Size = New Size(350, 158)
        Button8.TabIndex = 2
        ...
        Button9.Location = New Point(746, 200)
        Button9.Margin = New Padding(3, 2, 3, 2)
        Button9.Name = "Button9"
        Button9.Size = New Size(350, 158)
        Button9.TabIndex = 3
        ...
        Button10.Location = New Point(746, 389)
        Button10.Margin = New Padding(3, 2, 3, 2)
        Button10.Name = "Button10"
        Button10.Size = New Size(350, 158)
        Button10.TabIndex = 5
        ...
        Button11.Location = New Point(361, 389)
        Button11.Margin = New Padding(3, 2, 3, 2)
        Button11.Name = "Button11"
        Button11.Size = New Size(350, 158)
        Button11.TabIndex = 4
        ...
        lblEventCount.BackColor = Color.FromArgb(CByte(3), CByte(92), CByte(19))
        lblEventCount.Font = New Font("Tahoma", 48F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblEventCount.ForeColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
        lblEventCount.ImageAlign = ContentAlignment.BottomLeft
        lblEventCount.Location = New Point(810, 254)
        lblEventCount.Name = "lblEventCount"
        lblEventCount.Size = New Size(74, 77)
        lblEventCount.TabIndex = 13
        lblEventCount.Text = "0"
        ' 
        ' lblStudentCount
        ' 
        lblStudentCount.AutoSize = True
        lblStudentCount.BackColor = Color.FromArgb(CByte(3), CByte(92), CByte(19))
        lblStudentCount.Font = New Font("Tahoma", 48F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblStudentCount.ForeColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
        lblStudentCount.ImageAlign = ContentAlignment.BottomLeft
        lblStudentCount.Location = New Point(1192, 254)
        lblStudentCount.Name = "lblStudentCount"
        lblStudentCount.Size = New Size(74, 77)
        lblStudentCount.TabIndex = 14
        lblStudentCount.Text = "0"
        ' 
        ' lblFeedbackCount
        ' 
        lblFeedbackCount.AutoSize = True
        lblFeedbackCount.BackColor = Color.FromArgb(CByte(3), CByte(92), CByte(19))
        lblFeedbackCount.Font = New Font("Tahoma", 48F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblFeedbackCount.ForeColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
        lblFeedbackCount.ImageAlign = ContentAlignment.BottomLeft
        lblFeedbackCount.Location = New Point(425, 443)
        lblFeedbackCount.Name = "lblFeedbackCount"
        lblFeedbackCount.Size = New Size(74, 77)
        lblFeedbackCount.TabIndex = 15
        lblFeedbackCount.Text = "0"
        ' 
        ' lblOrganizerCount
        ' 
        lblOrganizerCount.AutoSize = True
        lblOrganizerCount.BackColor = Color.FromArgb(CByte(3), CByte(92), CByte(19))
        lblOrganizerCount.Font = New Font("Tahoma", 48F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblOrganizerCount.ForeColor = Color.FromArgb(CByte(192), CByte(255), CByte(192))
        lblOrganizerCount.ImageAlign = ContentAlignment.BottomLeft
        lblOrganizerCount.Location = New Point(810, 443)
        lblOrganizerCount.Name = "lblOrganizerCount"
        lblOrganizerCount.Size = New Size(74, 77)
        lblOrganizerCount.TabIndex = 16
        lblOrganizerCount.Text = "0"
        ' 
        ' Dashboard
        ' 
        ...
        Controls.Add(lblOrganizerCount)
        Controls.Add(lblFeedbackCount)
        ...
        Controls.Add(Panel1)
        ForeColor = Color.FromArgb(CByte(230), CByte(252), CByte(234))
    ...
    Friend WithEvents lblFeedbackCount As Label
    Friend WithEvents lblOrganizerCount As Label

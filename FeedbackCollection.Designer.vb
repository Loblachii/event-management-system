...
Partial Class FeedbackCollection
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FeedbackCollection))
        Label5 = New Label()
        Label6 = New Label()
        Panel1 = New Panel()
        Label4 = New Label()
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(317, 36)
        Label5.TabIndex = 12
        Label5.Text = "Feedback Collection"
        ' 
        ' Label6
        ' 
        ...
        btnRecord.Text = "Add Feedback"
        btnRecord.UseVisualStyleBackColor = False
        ' 
        ' list_Feedback
        ' 
        list_Feedback.BackColor = Color.FromArgb(CByte(5), CByte(138), CByte(28))
        list_Feedback.Font = New Font("Tahoma", 12F)
        list_Feedback.ForeColor = Color.FromArgb(CByte(230), CByte(252), CByte(234))
        list_Feedback.FullRowSelect = True
        list_Feedback.GridLines = True
        list_Feedback.Location = New Point(356, 163)
        list_Feedback.Name = "list_Feedback"
        list_Feedback.Size = New Size(1122, 489)
        list_Feedback.TabIndex = 33
        list_Feedback.UseCompatibleStateImageBehavior = False
        ' 
        ' FeedbackCollection
        ' 
    ...
    Friend WithEvents list_Feedback As ListView
End Class

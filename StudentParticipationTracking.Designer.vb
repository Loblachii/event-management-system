...
Partial Class StudentParticipationTracking
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(StudentParticipationTracking))
        Panel1 = New Panel()
        Label4 = New Label()
        Label3 = New Label()
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(474, 36)
        Label5.TabIndex = 12
        Label5.Text = "Student Participation Tracking"
        ' 
        ' Label6
        ' 
        ...
        ' btnAdd
        ' 
        btnAdd.BackColor = Color.FromArgb(CByte(3), CByte(92), CByte(19))
        btnAdd.Cursor = Cursors.Hand
        btnAdd.FlatStyle = FlatStyle.Popup
        btnAdd.Font = New Font("Tahoma", 10.2F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnAdd.ForeColor = Color.FromArgb(CByte(230), CByte(252), CByte(234))
        btnAdd.Location = New Point(1200, 71)
        btnAdd.Margin = New Padding(3, 2, 3, 2)
        btnAdd.Name = "btnAdd"
        btnAdd.Size = New Size(278, 28)
        btnAdd.TabIndex = 30
        ...
        ' list_student
        ' 
        list_student.BackColor = Color.FromArgb(CByte(5), CByte(138), CByte(28))
        list_student.Font = New Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        list_student.ForeColor = Color.FromArgb(CByte(230), CByte(252), CByte(234))
        list_student.FullRowSelect = True
        list_student.GridLines = True
        list_student.Location = New Point(360, 163)
        list_student.Name = "list_student"
        list_student.Size = New Size(1122, 489)
        list_student.TabIndex = 32
        list_student.UseCompatibleStateImageBehavior = False
        ' 
        ' btnEdit
        ' 
        ...
        Name = "StudentParticipationTracking"
        StartPosition = FormStartPosition.CenterScreen
        Text = "StudentParticipationTracking"
    ...
    Friend WithEvents list_student As ListView

...
Partial Class OrganizerTracking
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OrganizerTracking))
        Panel1 = New Panel()
        Label4 = New Label()
        Label3 = New Label()
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(302, 36)
        Label5.TabIndex = 12
        Label5.Text = "Organizer Tracking"
        ' 
        ' Label6
        ' 
        ...
        ' list_organizer
        ' 
        list_organizer.BackColor = Color.FromArgb(CByte(5), CByte(138), CByte(28))
        list_organizer.Font = New Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        list_organizer.ForeColor = Color.FromArgb(CByte(230), CByte(252), CByte(234))
        list_organizer.FullRowSelect = True
        list_organizer.GridLines = True
        list_organizer.Location = New Point(356, 163)
        list_organizer.Name = "list_organizer"
        list_organizer.Size = New Size(1122, 489)
        list_organizer.TabIndex = 31
        list_organizer.UseCompatibleStateImageBehavior = False
        ' 
        ' OrganizerTracking
        ' 
        ...
        Name = "OrganizerTracking"
        StartPosition = FormStartPosition.CenterScreen
        Text = "OrganizerTracking"
    ...
    Friend WithEvents list_organizer As ListView
End Class

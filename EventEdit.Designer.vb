...
Partial Class EventEdit
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(EventEdit))
        ...
        txtEventID.Location = New Point(550, 224)
        txtEventID.MinimumSize = New Size(330, 27)
        txtEventID.Name = "txtEventID"
        txtEventID.Size = New Size(330, 27)
        txtEventID.TabIndex = 82
        ' 
        ' cmbOrganizer
        ' 
        cmbOrganizer.BackColor = SystemColors.Window
        cmbOrganizer.Cursor = Cursors.Hand
        cmbOrganizer.Font = New Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        cmbOrganizer.FormattingEnabled = True
        cmbOrganizer.Location = New Point(1017, 406)
        cmbOrganizer.Name = "cmbOrganizer"
        cmbOrganizer.Size = New Size(330, 27)
        cmbOrganizer.TabIndex = 81
        ' 
        ' dtpEventDate
        ' 
        dtpEventDate.CalendarFont = New Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        dtpEventDate.Font = New Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        dtpEventDate.Location = New Point(550, 344)
        dtpEventDate.Name = "dtpEventDate"
        dtpEventDate.Size = New Size(330, 27)
        dtpEventDate.TabIndex = 80
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(1017, 381)
        Label10.Name = "Label10"
        Label10.Size = New Size(111, 16)
        Label10.TabIndex = 79
        Label10.Text = "Event Organizer"
        ' 
        ' Label11
        ' 
        ...
        Label11.Location = New Point(1017, 201)
        Label11.Name = "Label11"
        Label11.Size = New Size(121, 16)
        Label11.TabIndex = 78
        Label11.Text = "Event Description"
        ' 
        ' txtDescription
        ' 
        ...
        txtDescription.MaximumSize = New Size(0, 210)
        txtDescription.MinimumSize = New Size(330, 150)
        txtDescription.Name = "txtDescription"
        txtDescription.Size = New Size(330, 150)
        ...
        Label12.Location = New Point(550, 381)
        Label12.Name = "Label12"
        Label12.Size = New Size(103, 16)
        Label12.TabIndex = 76
        Label12.Text = "Event Location"
        ' 
        ' txtLocation
        ' 
        txtLocation.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtLocation.Location = New Point(550, 406)
        txtLocation.MaximumSize = New Size(330, 27)
        txtLocation.MinimumSize = New Size(330, 27)
        txtLocation.Name = "txtLocation"
        txtLocation.Size = New Size(330, 27)
        txtLocation.TabIndex = 75
        ' 
        ' labelss
        ' 
        labelss.AutoSize = True
        labelss.Font = New Font("Tahoma", 9.75F, FontStyle.Bold)
        labelss.ForeColor = Color.FromArgb(CByte(2), CByte(46), CByte(9))
        labelss.Location = New Point(550, 321)
        labelss.Name = "labelss"
        labelss.Size = New Size(79, 16)
        labelss.TabIndex = 74
        labelss.Text = "Event Date"
        ' 
        ' labelsss
        ' 
        labelsss.AutoSize = True
        labelsss.Font = New Font("Tahoma", 9.75F, FontStyle.Bold)
        labelsss.ForeColor = Color.FromArgb(CByte(2), CByte(46), CByte(9))
        labelsss.Location = New Point(550, 261)
        labelsss.Name = "labelsss"
        labelsss.Size = New Size(83, 16)
        labelsss.TabIndex = 73
        labelsss.Text = "Event Name"
        ' 
        ' txtEventName
        ' 
        txtEventName.Font = New Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtEventName.Location = New Point(550, 284)
        txtEventName.Name = "txtEventName"
        txtEventName.Size = New Size(330, 27)
        txtEventName.TabIndex = 72
        ' 
        ' Label7
        ' 
        ...
        ' btnDelete
        ' 
        btnDelete.BackColor = Color.FromArgb(CByte(3), CByte(92), CByte(19))
        btnDelete.Cursor = Cursors.Hand
        btnDelete.FlatStyle = FlatStyle.Popup
        btnDelete.Font = New Font("Tahoma", 10.2F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnDelete.ForeColor = Color.FromArgb(CByte(230), CByte(252), CByte(234))
        btnDelete.Location = New Point(1200, 651)
        btnDelete.Margin = New Padding(3, 2, 3, 2)
        btnDelete.Name = "btnDelete"
        btnDelete.Size = New Size(278, 28)
        ...
        btnUpdate.Font = New Font("Tahoma", 10.2F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnUpdate.ForeColor = Color.FromArgb(CByte(3), CByte(92), CByte(19))
        btnUpdate.Location = New Point(907, 651)
        btnUpdate.Margin = New Padding(3, 2, 3, 2)
        btnUpdate.Name = "btnUpdate"
        btnUpdate.Size = New Size(278, 28)
        ...
        btnCancel.Location = New Point(907, 71)
    ...
    Friend WithEvents labelss As Label
